    ...
    with_fx :echo, decay: 0.5, phase: 2 do
      live_loop :SNARES do
        ...
        pattern_sn.length.times do
          sample :sn_dolf, cutoff: 100, pan: rrand(-0.2, 0.5), amp: (pattern_sn[look].to_f / 9) if (pattern_sn[tick] != "-")
...
uncomment do
  live_loop :exp do
    use_synth :zawa
    play 60, amp: 0.3, release: rrand(0.5, 4), note: rrand(50,60)
    sleep 3
  end
end
